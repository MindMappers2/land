...
const Register = () => {
  ...
  const [form, setForm] = useState({ 
    ...
    password: "", 
    confirmPassword: "",
    userType: "rental" // Default to rental
  });
      ...
      <div className="login-container">
        <div className="login-sidebar">
          <div className="sidebar-content">
            <div className="brand-section">
              ...
              <h1>Land Rental</h1>
              <p>Join our community of landowners and renters</p>
            </div>
        ...
        <div className="login-form-section">
          <div className="form-header">
            ...
            <p>Join our platform to start your land journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="login-form">
              ...
              <div className="user-type-selection">
                <label className={`user-type-option ${form.userType === 'rental' ? 'active' : ''}`}>
                  ...
                  <div className="option-content">
                    ...
                    <div className="option-text">
                      <span className="option-title">Rental Account</span>
                ...
                <label className={`user-type-option ${form.userType === 'owner' ? 'active' : ''}`}>
                  ...
                  <div className="option-content">
                    <div className="option-icon">👨‍💼</div>
                    <div className="option-text">
                      <span className="option-title">Owner Account</span>
                      <span className="option-description">List your properties</span>
                    </div>
                  </div>
                </label>
              </div>
            ...
            <button type="submit" disabled={isLoading} className="submit-button">
              {isLoading ? (
                ...
                `Create ${form.userType === 'owner' ? 'Owner' : 'Rental'} Account`
              )}
            </button>
